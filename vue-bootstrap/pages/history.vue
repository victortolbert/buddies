      ...
      <article>
        <a
          ...
          <p class="md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">
            Over the last few weeks, we've been having a ton of fun dumping new
            and exciting features into Tailwind. Now feels like the right time
            to cut a release, so here it is — Tailwind CSS v2.2! We've built-in
            a new high-performance CLI tool, added before and after
      ...
      <article>
        <a
          ...
          <p class="md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">
            ...
            ever found." That person was James McDonald, and today we're totally
            over the moon to share that James is joining our team full-time.
          </p></a
        >
      </article>
    </li>
      ...
      <article>
        <a
          ...
          <p class="md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">
            ...
            Production, a new screencast series that teaches you everything you
            need to know to get up and running with Tailwind CSS v2.0 from
            scratch.
          </p></a
        >
      </article>
      ...
      <article>
        <a
          ...
          <p class="md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">
            ...
            ensuring we were following best practices and delivering markup that
            would work for everyone, no matter what tools they use to browse the
            web. Today we're excited to share that David has joined the team
            full-time!
          </p></a
        >
      </article>
      ...
      <article>
        <a
          ...
          <p class="md:col-start-3 md:col-span-6 xl:col-span-7 ml-9 md:ml-0">
            ...
            typography, and the photography you're using is really bringing the
            design to life.
          </p></a
        >
      </article>
