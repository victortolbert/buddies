<template>
  <main
    class="relative flex-1 w-full h-screen pb-4 bg-gray-100 dark:bg-gray-800"
  >
    <BasePageHeading>
      Dashboard
      <template #actions>
        <button
          type="button"
          class="inline-flex items-center px-4 py-2 space-x-2 text-sm font-medium border border-transparent rounded-md shadow-sm  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-primary-500"
        >
    ...
    <header
      ...
      class="flex items-center justify-between m-4"
    >
...
Title
        ...
        <div class="mt-4">
          <column-chart
            :data="[
              {
                name: '2020',
                data: { Jan: 3, Feb: 4, Mar: 5, Apr: 4, May: 8, Jun: 6 },
              },
              {
                name: '2021',
                data: { Jan: 5, Feb: 6, Mar: 4, Apr: 2, May: 7, Jun: 8 },
              },
            ]"
          />
        </div>
    ...
    >
      ...
      <section
        v-if="false"
        class="col-span-8 p-4 bg-white dark:bg-gray-900 lg:rounded-lg"
      >
        <header>
          <h2>{{ $t('comments') }}</h2>
