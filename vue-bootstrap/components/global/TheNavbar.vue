...
<template>
  <nav
    class="fixed top-0 z-10 w-full text-gray-800 bg-white  dark:bg-gray-900 dark:text-gray-50"
  >
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
          ...
          <div v-if="userInfo" class="hidden md:ml-6 md:flex md:space-x-8">
            ...
            >
              <a
                ...
                :class="[
                  {
                    'border-transparent  hover:border-gray-300 hover:text-gray-700 dark:hover:border-gray-300 dark:hover:text-gray-300':
                      !isActive,
        ...
        <div class="flex items-center space-x-3">
          <div
            class="space-x-3 md:ml-4 md:flex-shrink-0 md:flex md:items-center"
          >
            <!-- User info -->
