module.exports = [
  ...
  },
  {
    ...
    details:
      "While most houseplants require a bit of effort in providing appropriate growing conditions (light, temperature, humidity, etc.), growing Chinese evergreens can make even the novice indoor gardener look like an expert. Unfortunately, these are toxic to cats.",
    toxicity: {
      property: "Contains insoluble calcium oxalates",
      symptoms:
        "Can cause oral irritation, pain and swelling of mouth, tongue and lips, excessive drooling, vomiting, difficulty swallowing",
    },
    care: {
  ...
  },
  {
    ...
    details:
      "Fiddle-leaf fig trees are the “it” houseplant that refuses to go away. This plant graces the covers and photos of many design publications, bringing drama and height, and tying entire rooms together with its tall stature and enormous, elegant leaves. However, this plant is toxic to both dogs and cats. ",
    toxicity: {
      property: "Contains insoluble calcium oxalates",
      symptoms:
        "Can cause oral irritation, pain and swelling of mouth, tongue and lips, excessive drooling, vomiting, difficulty swallowing",
  ...
  },
  {
    ...
    details:
      "Monstera deliciosa's are one of the most trendy tropical houseplants and are featured extensively on social media and in home decor thanks to their stunning tropical foliage. Monsteras are relatively low maintenance, making them an attractive addition to any home, but unfortunately, they are highly toxic to cats. ",
    toxicity: {
      property: "Contains insoluble calcium oxalates",
      symptoms:
        "Can cause oral irritation, pain and swelling of mouth, tongue and lips, excessive drooling, vomiting, difficulty swallowing",
  ...
  },
  {
    ...
    details:
      "If you have a passion for orchids, you can safely add them to your go-to list of pet-safe plants. Many orchids bloom for weeks in the winter when days are short, thriving in partial light and root-bound conditions.",
    care: {
      light: "Bright, indirect light",
      water: "Water every 1-2 weeks",
    },
  ...
  },
  {
    ...
    details:
      "Rubber trees can be enjoyed as either medium-sized house plants or grown to become focal point, beautiful indoor trees. There are many varieties of the rubber tree plants and some of them (such as Japanese/Chinese/jade rubber plant and Indian rubber plant) are toxic to cats and dogs.",
    toxicity: {
      property: "Toxic property is unknown",
      symptoms:
        "Can cause decreased appetite, drooling, vomiting, diarrhoea, depression, and skin irritation",
    },
    care: {
      light: "Medium to bright, indirect light",
      water: "Water every 1-2 weeks",
  ...
  },
  {
    ...
    details:
      "The snake plant is a wildly popular hard-to-kill houseplant anyone can grow. However, snake plants contain chemical compounds called saponins, which makes them toxic to cats.",
    toxicity: {
      property: "Contains saponins",
      symptoms:
        "Can cause vomiting (sometimes with and sometimes without blood), diarrhea, weakness, drooling, loss of appetite, depression, and dilated pupils",
